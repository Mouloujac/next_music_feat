...
export default function Card (){
    ...
    return (
        <>
        <div className="card py-5 w-full flex ">
            <div className="albumDiv relative w-14">
            <img className="w-14 z-10 absolute" src="albumImage.jpeg"></img>
            ...
            <div className="flex justify-betweenw-full">
                <div className="trackName ml-5 mt-1 flex flex-col justify-start items-start">
                    <p><span className="hover:underline">Snoop Dogg</span>, <span className="hover:underline">Dr.Dre</span></p>
                    <p><span className="text-gray-300 hover:underline">Doggy dogg World</span></p>
                </div>
